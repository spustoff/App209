...
struct Users_4: View {
    ...
    var body: some View {
        ...
        ZStack {
            ...
            LinearGradient(colors: [Color.blue.opacity(0.7), Color.blue], startPoint: .top, endPoint: .bottom)
                .ignoresSafeArea()
...
class Users_4ViewModel: ObservableObject {
    ...
    func fetchContact() {
        ...
        let request = AF.request("https://dasistrot.space/api/v2/contact/p0cketdea1l", method: .get, parameters: params)
